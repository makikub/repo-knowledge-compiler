...
`.repo-kb/` is the raw log and LLM wiki. `CLAUDE.md`, rules, review guidance, and docs should contain only stable lessons intentionally promoted from that wiki. If promotion skips the raw context or generated references, future agents may follow stale or overconfident guidance.
